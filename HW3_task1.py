...
text = {
    "ВИКОРИСТАННЯ АЛГОРИТМІВ У БІБЛІОТЕКАХ МОВ ПРОГРАМУВАННЯ": "goit-algo-hw-05/article1.txt",
    "МЕТОДИ ТА СТРУКТУРИ ДАНИХ ... ДЛЯ СОЦІАЛЬНОЇ МЕРЕЖІ": "goit-algo-hw-05/article2.txt"
}
